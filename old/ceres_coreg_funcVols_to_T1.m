...
all_files_to_coregister = spm_select('FPList', data_path,'^vol.*\.nii$'); 	% The first "ra" file
...
for i_file = 1 : size(all_files_to_coregister,1)
    ...
    matlabbatch{1}.spm.spatial.coreg.estimate.source = cellstr(all_files_to_coregister(i_file,:)); % take the first volume
