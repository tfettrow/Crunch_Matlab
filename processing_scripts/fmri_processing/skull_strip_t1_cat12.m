...
matlabbatch{1}.spm.util.imcalc.input = {
    spm_select('ExtFPList',[data_path '\CAT12_Analysis\mri'], '^p1T1.nii$')
    spm_select('ExtFPList',[data_path '\CAT12_Analysis\mri'], '^p2T1.nii$')
    spm_select('ExtFPList',[data_path '\CAT12_Analysis\mri'], '^p3T1.nii$')
