%% ********************************************************************************************************************* %%
%%	Run network segregation analysis, INCLUDING negative values (METRIC 1/3)											 %%
...
function [seg,within,between] = segregation(wholenetwork,nodes)
% segregation(wholenetwork,nodes)
%% --------------------------------------------------------------------------------------------------------------------- %%
%% 										               FUNCTION SUMMARY										             %% 
%% --------------------------------------------------------------------------------------------------------------------- %%
...
%    This function returns all 3 of these values: seg, within, & between
