...
function subject_segregation_SS(varargin)
close all
parser = inputParser;
parser.KeepUnmatched = true;
% setup defaults in case no arguments specified
addParameter(parser, 'conn_project_name', 'conn_SSROIs_SS_cb_23Apr30')
addParameter(parser, 'outfile','SS_cb_23Apr30')
...
if save_scores
    ...
    writetable(within_results_table, fullfile(project_path, conn_project_name, 'results', 'within_score.csv'))
    writetable(between_results_table, fullfile(project_path, conn_project_name, 'results', 'between_score.csv'))
    writetable(seg_results_table, fullfile(project_path, conn_project_name, 'results', 'seg_score.csv'))
