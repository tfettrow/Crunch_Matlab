function convert_to_suitVoxel_coordinates(roi_name, roi_x, roi_y, roi_z)
% roi_name = 'caudate';
...
this_contrast_data = spm_vol('SUIT_Labeling_Files/SUIT_2mm.nii');
...
writetable(T, strcat('suitVoxel_',roi_name,'.csv'))
