...
function ceres_level_one_stats(create_model_and_estimate, TR_from_json)
...
create_model_and_estimate=1;
    ...
    % SPM norm files (need to be able to exclude smothed T1)
        files_to_test = spm_select('FPList', data_path, '^coreg.*\.nii$');
%     files_to_test = spm_select('FPList', data_path, '^unwarpedRealigned.*\.nii$');
