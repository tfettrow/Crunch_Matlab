function extract_cortical_depth(varargin)
...
for this_subject_index = 1 : length(subjects)
    ...
    subject_image = fullfile(project_path, subjects{this_subject_index}, 'Processed', 'MRI_files', '02_T1', 'CAT12_Analysis', 'surf', 's20.mesh.depth.resampled_32k.T1.gii');
...
%     ylim([0 1])
    ...
    if save_figures
        fig_title = ['depth_' roi_name_cell{this_roi_index}];
